const products = {
  llaveros: {
    ...
    items: [
      { id: 1, name: '"A" a blanco y  negro', price: 10000, image: `${process.env.PUBLIC_URL}/images/llaveros/llavero1.jpg`, description: 'Llavero personalizado a blanco y negro de manera horizontal' },
      ...
      { id: 3, name: '"I" a blanco y negro', price: 10000, image: `${process.env.PUBLIC_URL}/images/llaveros/llavero4.jpg`, description: 'Llavero personalizado a blanco y negro de manera horizontal' },
  ...
  cuadros: {
    ...
    items: [
      ...
      { id: 4, name: 'RI  CK', price: 25000, image: `${process.env.PUBLIC_URL}/images/cuadros/cuadro4.jpg`, overlay: `${process.env.PUBLIC_URL}/images/cuadros/cuadrosFondoTransparente/cuadro4.png`, description: 'Cuadro decorativo en madera mdf 3mm con medida maxima de 40cm' },
